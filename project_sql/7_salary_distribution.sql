...
SELECT
    CASE
        WHEN salary_year_avg < 60000 THEN '0-60k'
        WHEN salary_year_avg BETWEEN 60000 AND 80000 THEN '60k-80k'
        WHEN salary_year_avg BETWEEN 80000 AND 100000 THEN '80k-100k'
        WHEN salary_year_avg BETWEEN 100000 AND 120000 THEN '100k-120k'
        ELSE '120k+'
    END AS salary_range,
    COUNT(*) AS job_count
